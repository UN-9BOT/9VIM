...
- [ ] `8vim/src/androidTest/kotlin/inc/flide/vim8/app/LanguageProfilesScreenTest.kt` — unified list, up/down controls, primary radio, custom detail dialog, final-enabled toggle/delete explanation, distinct-primary removal, active-primary deterministic next/previous promotion, and persistence.
